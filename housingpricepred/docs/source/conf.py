...
# housingpricepred documentation build
...
from housingpricepred import __version__ as release

# -- Project information -----------------------------------------------------

project = "housingpricepred"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "housingpricepreddoc"
...
latex_documents = [
    (
        master_doc,
        "housingpricepred.tex",
        "housingpricepred Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "housingpricepred",
        "Project housingpricepred codebase.",
        "Data-Science",
    )
]
